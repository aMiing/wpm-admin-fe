  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="名称" prop="name">
        <el-input v-model.trim="form.name" autocomplete="off" placeholder="输入商品名称" />
      </el-form-item>
      <el-form-item label="单价" prop="price">
        ...
        <div v-if="priceType === 'single'" class="single-box price-form-content">
          <el-input v-model.trim="form.price" autocomplete="off" placeholder="输入单价金额" />
        </div>
        <div v-else class="multiple-box price-form-content">
          <multiple-price-form ref="multipleForm" :price-range="priceRange" />
        </div>
      </el-form-item>
      <el-form-item label="库存" prop="stock">
        <el-input v-model.trim.number="form.stock" autocomplete="off" placeholder="输入当前库存" />
      </el-form-item>
    ...
    <el-divider content-position="right">
      <a @click="showMore = !showMore">{{ showMore ? '收起' : '更多' }}</a>
    </el-divider>
